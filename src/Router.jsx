...
const router = createBrowserRouter(
  [
    ...
    {
      path: '*',
      element: <div className='flex items-center justify-center w-screen h-screen bg-white text-black'>
        <p className='text-lg flex flex-col items-center gap-4'>
          ...
          <span className='text-sm text-gray-500'>If you think this is an error, please contact support.</span>
        </p>
      </div>
    }
  ]
