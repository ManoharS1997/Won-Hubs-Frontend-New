...
const templatesData = [
  { name: 'Catalog Form', category: 'IT', mode: 'Desktop', widgetname: 'Catelogform', path: '/create/new/design/CatalogForm' },
  { name: 'Admin Portal Forms', category: 'HR', mode: 'Mobile', widgetname: 'AdminPortalForms', path: '/create/new/design/AdminPortalForms' },
  { name: 'Widget 3', category: 'IT', mode: 'Tab', widgetname: '', path: '/create/new/design/Widget3' },
  { name: 'Widget 4', category: 'HR', mode: 'Mobile', widgetname: '', path: '/create/new/design/Widget4' },
  { name: 'Widget 5', category: 'Sales', mode: 'Desktop', widgetname: '', path: '/create/new/design/Widget5' },
  { name: 'Widget 6', category: 'Agent', mode: 'Tab', widgetname: '', path: '/create/new/design/Widget6' },
  // More dummy data
  { name: 'User Profile', category: 'User', mode: 'Desktop', widgetname: 'UserProfile', path: '/create/new/design/UserProfile' },
  { name: 'Sales Dashboard', category: 'Sales', mode: 'Tab', widgetname: 'SalesDashboard', path: '/create/new/design/SalesDashboard' },
  { name: 'HR Onboarding', category: 'HR', mode: 'Desktop', widgetname: 'HROnboarding', path: '/create/new/design/HROnboarding' },
  { name: 'Agent Tracker', category: 'Agent', mode: 'Mobile', widgetname: 'AgentTracker', path: '/create/new/design/AgentTracker' },
  { name: 'IT Support', category: 'IT', mode: 'Mobile', widgetname: 'ITSupport', path: '/create/new/design/ITSupport' },
  { name: 'User Feedback', category: 'User', mode: 'Tab', widgetname: 'UserFeedback', path: '/create/new/design/UserFeedback' },
  { name: 'Sales Report', category: 'Sales', mode: 'Mobile', widgetname: 'SalesReport', path: '/create/new/design/SalesReport' },
  { name: 'Admin Dashboard', category: 'HR', mode: 'Tab', widgetname: 'AdminDashboard', path: '/create/new/design/AdminDashboard' },
  { name: 'Agent Portal', category: 'Agent', mode: 'Desktop', widgetname: 'AgentPortal', path: '/create/new/design/AgentPortal' },
  { name: 'IT Inventory', category: 'IT', mode: 'Tab', widgetname: 'ITInventory', path: '/create/new/design/ITInventory' },
    ...
    <div className='w-full h-full flex flex-col overflow-auto'>
      <div className='w-full h-full flex flex-col p-4'>
        ...
        <div className='w-full h-fit'>
          ...
          >
            {templatesData.filter(template => template.category === category && template.mode === selectedTab).length > 0 ?
              templatesData.filter(template => template.category === category && template.mode === selectedTab)
                .map((item, index) => (
                  <Link
                    key={index}
                    onClick={() => {
                    ...
                    to={{ pathname: item.path, state: { widgetname: item.widgetname } }}
                  >
                    <p className='m-0'>{item.name}</p>
                  </Link>
                ))
              : <p className='text-center text-gray-500'>No templates available for this selection</p>}
            {templatesData.filter(template => template.category === category && template.mode === selectedTab).length > 0 &&
              <li
                onClick={() => {
                  setOpenConfigure(true)
                ...
                to={{ pathname: `/create/new/design/New`, state: { widgetname: '' } }}
              >
          ...
          <div className="flex flex-col justify-between items-center w-fit bg-white py-4 px-8 rounded-lg gap-4">
            ...
            <div className="w-[280px] mx-1 border rounded" >
              <ReactSelect
                ...
                values={views.filter(view => selectedViews.includes(view)).map(view => ({ label: view, value: view }))}
            ...
            <button
              type="submit"
              onClick={() => Navigate('/create/new/design/New')}
