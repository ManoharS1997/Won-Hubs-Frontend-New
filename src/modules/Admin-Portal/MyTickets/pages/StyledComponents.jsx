...
export const TabItem = styled.button`
    min-width: 100px;
    background-color: transparent;
    color: ${({ active }) => active ? '#4361ee' : '#8b8c89'};
    border-radius: ${({ active }) => active ? '0px' : '5px 5px 0px 0px'};
    border: none;
    cursor: pointer;
    border-bottom:  ${({ active }) => active ? '3px solid #4361ee' : 'none'};
    
    &:hover {
        color:  ${({ active }) => active ? '#4361ee' : '#000'};
    }
