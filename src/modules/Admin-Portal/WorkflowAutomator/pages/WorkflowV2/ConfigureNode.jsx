...
export default function ConfigureNode({
    data, setIsDetailsOpen, fieldInitialNodes,
    nodeStyles, iconStyles, style, xPos, yPos,
    handleStyles, id, sourcePosition, targetPosition,
    type
}) {
            ...
            {value => {
                ...
                return (
                    <div style={{ ...nodeStyles }} id='node'>
                        <FaHubspot size={20} style={{ ...iconStyles, color: 'purple' }} id='node' />
                        <NodeLabel htmlFor="text" id='node'> {data.label} </NodeLabel>
                        <Handle type="source" position={Position.Right} id="c" style={handleStyles} />
                        <Handle type="source" position={Position.Bottom} id="a" style={handleStyles} />
                        <Handle type="target" position={Position.Top} id="b" style={handleStyles} />
