            ...
            {value => {
                ...
                return (
                    <div style={nodeStyles} id='node'>
                        ...
                        <Handle type="source" position={'bottom'} id="c" style={{ ...handleStyles, backgroundColor: '#000', width: '10px', height: '10px' }} />
                        ...
                        <Strip id='node'>
                            ...
                            <StripItem
                                data-tooltip-id='info-tooltip' data-tooltip-place='right'
                                style={{ color: '#000' }}><RxInfoCircled size={18} /></StripItem>
                        </Strip>
                        <Tooltip
                            id='addNode-tooltip'
                            clickable
