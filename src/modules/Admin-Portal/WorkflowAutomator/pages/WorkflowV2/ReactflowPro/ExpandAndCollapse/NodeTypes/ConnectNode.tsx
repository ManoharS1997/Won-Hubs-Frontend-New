...
export default function ConnectNode({ data, id, xPos, yPos, type, setIsDetailsOpen, setFlowData, flowData }: NodeProps) {
      ...
      {value => {
        ...
        return (
          <div className={styles.node} id='node'>
            ...
            ></textarea>
            <PiPlugsConnectedBold style={{ ...iconStyles }} size={18} />
            ...
            <div className={styles.button} >
              ...
              <Strip id='node'>
                ...
                <StripItem data-tooltip-id={uniqueInfopopupId} id='actionBtn' data-tooltip-place='right' onClick={setIsDetailsOpen}><FaInfo size={10} /></StripItem>
              </Strip>
