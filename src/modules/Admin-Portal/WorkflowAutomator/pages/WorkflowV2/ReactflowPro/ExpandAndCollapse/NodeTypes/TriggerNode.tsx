...
export default function TriggerNode({ data, id, xPos, yPos, type, setIsDetailsOpen, setFlowData, flowData }: NodeProps) {
  // console.log(data)
        ...
        return (
          <div className={styles.node} id='node'>
            <textarea
              ...
              value={data.customLabel ? data.customLabel === '' ? label : data.customLabel.length > 27 ?
                data.customLabel.slice(0, 27) + '...' : data.customLabel : null}
            ></textarea>

            <TbTimelineEventPlus style={{ ...iconStyles }} size={18} />
            ...
            <div className={styles.button} >
              <Strip id='node'>
                <StripItem
                  ...
                  id='actionBtn'
                >
                  <FaPlus size={10} id='actionBtn' />
                </StripItem>

                {/* <StripItem data-tooltip-id={uniqueDeletepopupId} data-tooltip-place='right'><MdDeleteOutline size={10} /></StripItem> */}
                <StripItem data-tooltip-id={uniqueInfopopupId} id='actionBtn' data-tooltip-place='right' onClick={setIsDetailsOpen}><FaInfo size={10} id='actionBtn' /></StripItem>
              </Strip>
              ...
              >
                <NodeHelpPopupContainer >
                  ...
                  <HelpContentContainer>{'Description: ' + data.label}</HelpContentContainer>
                  {/* <HelpContentContainer>{'Description: ' + data.label}</HelpContentContainer>
                  <HelpContentContainer>{'Description: ' + data.label}</HelpContentContainer> */}
                </NodeHelpPopupContainer>
              </Tooltip>
